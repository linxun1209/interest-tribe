...
import com.xingchen.friends.mapper.TeamMapper;
...
import com.xingchen.friends.model.enums.TeamStatusEnum;
...
import com.xingchen.friends.model.vo.UserVO;
import com.xingchen.friends.service.TeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("xingchenn:join_team");
        try {
            // 抢到锁并执行
            while (true) {
